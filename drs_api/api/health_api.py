...
class HealthApi(object):
    ...
    def get_health_health_get(self, **kwargs):  # noqa: E501
        """Check if the API is running correctly  # noqa: E501

        Health check for the API  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_health_health_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_health_health_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_health_health_get_with_http_info(self, **kwargs):  # noqa: E501
        """Check if the API is running correctly  # noqa: E501

        Health check for the API  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_health_health_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_health_health_get" % key
                )
            params[key] = val
        del params['kwargs']
